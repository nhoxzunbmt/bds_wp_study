...
class acf_field_premium extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// actions
		add_action('wp_ajax_acf/fields/premium/get_attachment',				array($this, 'ajax_get_attachment'));
		add_action('wp_ajax_nopriv_acf/fields/premium/get_attachment',		array($this, 'ajax_get_attachment'));
		
		add_action('wp_ajax_acf/fields/premium/update_attachment',			array($this, 'ajax_update_attachment'));
		add_action('wp_ajax_nopriv_acf/fields/premium/update_attachment',	array($this, 'ajax_update_attachment'));
		
		add_action('wp_ajax_acf/fields/premium/get_sort_order',				array($this, 'ajax_get_sort_order'));
		add_action('wp_ajax_nopriv_acf/fields/premium/get_sort_order',		array($this, 'ajax_get_sort_order'));
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'acf-input-premium', acf_get_external_dir(__FILE__, 'js/input.js'), array('acf-input'), '2.0.0' );
		wp_enqueue_style( 'acf-input-premium', acf_get_external_dir(__FILE__, 'css/input.css'), array('acf-input'), '2.0.0' );
	...
	*/
	...
	function render_attachment( $id = 0, $field ) {
		...
		?>
		<div class="acf-premium-side-info">
			...
			<p class="actions">
				<a href="#" class="acf-premium-edit" data-id="<?php echo $id; ?>"><?php _e('Edit', 'acf'); ?></a>
				<a href="#" class="acf-premium-remove" data-id="<?php echo $id; ?>"><?php _e('Remove', 'acf'); ?></a>
			</p>
		</div>
...
<div <?php acf_esc_attr_e($atts); ?>>
	...
	<div class="acf-premium-main">
		
		<div class="acf-premium-attachments">
			...
			<?php if( $value ): ?>
				...
				<?php foreach( $value as $i => $v ): 
					...
					<div class="<?php echo $a['class']; ?>" data-id="<?php echo $a['ID']; ?>">
						...
						<div class="actions">
							<a class="acf-icon -cancel dark acf-premium-remove" href="#" data-id="<?php echo $a['ID']; ?>" title="<?php _e('Remove', 'acf'); ?>"></a>
						</div>
					</div>
				<?php endforeach; ?>
		...
		<div class="acf-premium-toolbar">
			
			<ul class="acf-hl">
				<li>
					<a href="#" class="acf-button button button-primary acf-premium-add"><?php _e('Add to gallery', 'acf'); ?></a>
				</li>
				<li class="acf-fr">
					<select class="acf-premium-sort">
	...
	<div class="acf-premium-side">
	<div class="acf-premium-side-inner">
			
		<div class="acf-premium-side-data"></div>
						
		<div class="acf-premium-toolbar">
			
			<ul class="acf-hl">
				<li>
					<a href="#" class="acf-button button acf-premium-close"><?php _e('Close', 'acf'); ?></a>
				</li>
				<li class="acf-fr">
					<a class="acf-button button button-primary acf-premium-update" href="#"><?php _e('Update', 'acf'); ?></a>
				</li>
			</ul>
