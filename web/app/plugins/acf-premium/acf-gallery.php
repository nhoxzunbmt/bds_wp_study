<?php
/*
Plugin Name: Advanced Custom Fields: Premium Shop
Plugin Slug: acf-premium
	...
	*/
	...
	function __construct() {
		...
		$this->settings = array(
			...
			// basic
			'name'				=> __('Advanced Custom Fields: Premium', 'acf'),
			'version'			=> '2.0.1',
		...
		// include v5 field
		add_action('acf/acf/include_field_types', array($this, 'include_field_types'));
...
// globals
global $acf_plugin_premium;


// instantiate
$acf_plugin_premium = new acf_plugin_premium();
