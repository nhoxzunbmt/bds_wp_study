...
class Estate_Writer {
	...
	public function has_address() {
		$address = $this->estate->get_address();
	...
	public function get_address() {
		return $this->estate->get_address();
	}
	...
	public function get_prices() {
		$show_all_prices = ! empty( \MyHomeCore\My_Home_Core()->settings->props['mh-single-estate_all-prices'] );
		...
		if ( ! $show_all_prices ) {
			...
			return $currency_prices->get_prices();
		}
	...
	public function get_attributes() {
		$attributes = array();
		foreach ( Attribute_Factory::get_not_core() as $attribute ) {
			if ( $attribute->get_property_show() ) {
				$attributes[] = new Estate_Attribute( $attribute, $this->estate->get_ID() );
			}
		}
