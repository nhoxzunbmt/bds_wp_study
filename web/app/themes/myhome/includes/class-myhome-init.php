	...
	class My_Home_Init {
		...
		public function google_api_key_notice() {
			...
			<div class="notice notice-error">
				<p>
					...
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=' . wp_get_theme()->get( 'Name' ) . '&tab=1' ) ); ?>">
		...
		public function add_sidebars() {
			...
			if ( isset( $options['mh-footer-widget-area-columns'] ) ) {
				$footer_columns_class = $options['mh-footer-widget-area-columns'];
			} else {
			...
			register_sidebar(
				array(
					...
					'description'   => esc_html__( 'Add widgets here.', 'myhome' ),
					'before_widget' => '<div class="mh-footer__row__column ' . $footer_columns_class . ' widget %2$s" id="%1$s">',
					'after_widget'  => '</div>',
