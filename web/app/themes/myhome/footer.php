...
<footer
	...
	<?php if ( $myhome_footer->has_background_image() ) : ?>
		style="<?php echo esc_attr( $myhome_footer->get_style() ); ?>"
        data-bgset="<?php echo esc_attr( wp_get_attachment_image_srcset( $myhome_footer->get_background_image_id(), 'myhome-standard-xxxl' ) ) ?>"
		data-sizes="auto"
	<?php endif; ?>
>
